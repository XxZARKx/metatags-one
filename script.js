...
cardTitle = [...document.querySelectorAll('.cardTitle')],
descriptionInput = document.querySelector("#descriptionInput"),
cardDescription = Array.from(document.querySelectorAll('.cardDescription')),
imageInput = document.querySelector('#imageInput'),
cardImages = document.querySelectorAll('#cardImages'),
generateMetaTags = document.querySelector('#generateMetaTags');
...
const switchListItemsStatus = (listItem) => {
...
listItems.forEach((listItem) => {
    listItem.addEventListener('click', () => {
        switchListItemsStatus(listItem)
...
const updateCardDescription = (value) => {
...
imageInput.addEventListener('change', async ({target}) => {
    try{
        ...
        const url = await getUrlImageByFiles(file)
